...
\section{CSI Estimation}
    ...
    % \footnotesize{
      ...
      \begin{enumerate}
        ...
        \begin{align*}
          (1-\delta)\| \mathbf h \|_2^2 \leq \| \mathbf A \mathbf h \|_2^2 \leq (1+\delta)\| \mathbf h \|_2^2 
        \end{align*}
      \end{enumerate}
    % }
    \end{frame}
      ...
      \begin{columns}
        \begin{column}{0.6\textwidth}
          ...
          \begin{itemize}
            ...
            \begin{align*}
              \text{NMSE} = \frac 1N \sum_{i}^N \frac{\|\mathbf H_i - \hat{\mathbf H}_i \|_2^2}{\|\mathbf H_i \|_2^2}
            \end{align*}
            \item \textbf{Cosine Similarity}
            \begin{align*}
              \rho = \frac 1N \sum_{i}^N \frac{|\bar{\mathbf H}_i \cdot \hat{\bar{\mathbf H}}_i |}{\|\bar{\mathbf H}_i \|_2\|\hat{\bar{\mathbf H}}_i \|_2}
            \end{align*}
          \end{itemize}
          \pause
...
% \oubsection{Results}
  ...
  \begin{frame}{Differential Entropy Estimation}
    \footnotesize{
      ...
      \end{align*}
      \pause
      In practice, the distribution $p(\mathbf H{(i,j)})$ in difficult to obtain. We can instead resort to the Kozachenko–Leonenko (KL) estimator \cite{ref:Kozachenko1987SampleEstimate} for each element in $\mathbf H$ and average over the elements,
      \begin{align*}
  ...
  \begin{frame}{Future Work: Rate-Distortion Bound}
    \begin{figure}[htb] \centering 
      ...
      \caption{Rate distortion of CsiNet-SoftQuant with current entropy bound based on $\hat H(\mathbf H^\Delta)$.} 
